$businesses = @(
    @{ id="fliesenleger-sengenberger"; name="Fliesenleger Sengenberger"; owner="Herr Sengenberger"; trade="Fliesen & Naturstein"; address="Dresden-Briesnitz"; phone="0351 12345601"; email="kontakt@sengenberger-fliesen.de"; color1="#0f172a"; color2="#3b82f6"; color3="#1e293b"; icon="🧱"; bg="../hero_fliesen.png"; srv1_t="Badsanierung"; srv1_d="Komplette Badgestaltung aus einer Hand."; srv2_t="Großformatfliesen"; srv2_d="Moderne XXL-Fliesen für fugenlose Optik."; srv3_t="Naturstein"; srv3_d="Hochwertige Natursteinarbeiten für drinnen und draußen." },
    @{ id="fliesenleger-seifert"; name="Fliesenleger Seifert"; owner="Sven Seifert"; trade="Badsanierung & Fliesen"; address="Dresden-Striesen"; phone="0172 23456702"; email="info@seifert-fliesen.de"; color1="#18181b"; color2="#10b981"; color3="#27272a"; icon="🛁"; bg="../hero_fliesen.png"; srv1_t="3D Badplanung"; srv1_d="Wir visualisieren Ihr neues Bad vorab."; srv2_t="Mosaikarbeiten"; srv2_d="Detailverliebte Mosaike für besondere Akzente."; srv3_t="Balkon & Terrasse"; srv3_d="Frostsichere Verlegung im Außenbereich." },
    @{ id="klempnerei-wagner"; name="Klempnerei Wagner"; owner="Herr Wagner"; trade="Sanitär & Heizung"; address="Dresden-Prohlis"; phone="0351 34567803"; email="service@wagner-sanitaer.de"; color1="#0c4a6e"; color2="#38bdf8"; color3="#075985"; icon="🚰"; bg="../hero_fliesen.png"; srv1_t="Heizungsbau"; srv1_d="Effiziente Heizsysteme und Wärmepumpen."; srv2_t="Sanitärinstallation"; srv2_d="Moderne Wasserinstallationen für Neubau und Sanierung."; srv3_t="Notdienst"; srv3_d="Schnelle Hilfe bei Rohrbrüchen und Störungen." },
    @{ id="dachdecker-franke"; name="Dachdeckermeister Franke"; owner="Herr Franke"; trade="Bedachungen & Spenglerei"; address="Dresden-Leuben"; phone="0173 45678904"; email="info@dach-franke.de"; color1="#451a03"; color2="#fb923c"; color3="#78350f"; icon="🏠"; bg="../hero_haus.png"; srv1_t="Steildach"; srv1_d="Ziegeldächer, Schiefer und Neueindeckungen."; srv2_t="Flachdach"; srv2_d="Abdichtungen und Flachdachsanierungen."; srv3_t="Klempnerei"; srv3_d="Dachrinnen, Fallrohre und Blecharbeiten." },
    @{ id="gartenbau-schmidt"; name="Gartenbau Schmidt"; owner="Herr Schmidt"; trade="Landschaftsarchitektur & Pflege"; address="Dresden-Pieschen"; phone="0351 56789005"; email="post@garten-schmidt-dresden.de"; color1="#14532d"; color2="#4ade80"; color3="#166534"; icon="🌳"; bg="../hero_haus.png"; srv1_t="Gartengestaltung"; srv1_d="Wir planen und bauen Ihre grüne Oase."; srv2_t="Pflasterarbeiten"; srv2_d="Wege, Einfahrten und Terrassen aus Naturstein."; srv3_t="Baumpflege"; srv3_d="Professioneller Gehölzschnitt und Fällungen." },
    @{ id="trockenbau-lehmann"; name="Trockenbau Lehmann"; owner="Herr Lehmann"; trade="Innenausbau & Akustik"; address="Dresden-Gorbitz"; phone="0174 67890106"; email="info@lehmann-ausbau.de"; color1="#1e293b"; color2="#94a3b8"; color3="#334155"; icon="🏗️"; bg="../hero_holz.png"; srv1_t="Decken & Wände"; srv1_d="Abhängte Decken und leichte Trennwände."; srv2_t="Akustikbau"; srv2_d="Optimierung der Raumakustik für Büros und Wohnräume."; srv3_t="Dachausbau"; srv3_d="Schaffung von neuem Wohnraum unterm Dach." },
    @{ id="tischlerei-berger"; name="Tischlerei Berger"; owner="Herr Berger"; trade="Fensterbau & Maßmöbel"; address="Dresden-Klotzsche"; phone="0351 78901207"; email="kontakt@tischlerei-berger.de"; color1="#422006"; color2="#d97706"; color3="#78350f"; icon="🪚"; bg="../hero_holz.png"; srv1_t="Maßmöbel"; srv1_d="Individuelle Einbauschränke und Möbelstücke."; srv2_t="Fenster & Türen"; srv2_d="Montage von energieeffizienten Fenstern und Haustüren."; srv3_t="Innenausbau"; srv3_d="Holzböden, Treppen und Wandverkleidungen." },
    @{ id="gebaeudereinigung-glanzstueck"; name="Gebäudereinigung Glanzstück"; owner="Das Glanzstück-Team"; trade="Gewerbe- & Unterhaltsreinigung"; address="Dresden-Neustadt"; phone="0175 89012308"; email="info@glanzstueck-dresden.de"; color1="#082f49"; color2="#0ea5e9"; color3="#0369a1"; icon="✨"; bg="../hero_haus.png"; srv1_t="Unterhaltsreinigung"; srv1_d="Regelmäßige Reinigung für Büros und Kanzleien."; srv2_t="Glasreinigung"; srv2_d="Streifenfreie Fenster, Schaufenster und Fassaden."; srv3_t="Bauendreinigung"; srv3_d="Grundreinigung nach Neubau oder Sanierung." },
    @{ id="geruestbau-richter"; name="Gerüstbau Richter"; owner="Herr Richter"; trade="Fassadengerüste & Sonderbau"; address="Dresden-Cotta"; phone="0351 90123409"; email="anfrage@richter-geruest.de"; color1="#27272a"; color2="#eab308"; color3="#3f3f46"; icon="🪜"; bg="../hero_holz.png"; srv1_t="Fassadengerüste"; srv1_d="Sichere Arbeitsgerüste für Maler und Dachdecker."; srv2_t="Schutzgerüste"; srv2_d="Dachfanggerüste und Passantenschutz."; srv3_t="Sonderkonstruktionen"; srv3_d="Individuelle Gerüstlösungen für komplexe Bauten." },
    @{ id="malerbetrieb-hoffmann"; name="Malerbetrieb Hoffmann"; owner="Herr Hoffmann"; trade="Kreative Wandgestaltung"; address="Dresden-Löbtau"; phone="0176 01234510"; email="maler-hoffmann@web.de"; color1="#312e81"; color2="#8b5cf6"; color3="#4338ca"; icon="🎨"; bg="../hero_haus.png"; srv1_t="Tapezierarbeiten"; srv1_d="Fachgerechtes Tapezieren aller Tapetenarten."; srv2_t="Lackieren & Lasieren"; srv2_d="Schutz und Veredelung von Holz und Metall."; srv3_t="Fassadengestaltung"; srv3_d="Wetterschutz und neue Farbe für Ihr Haus." }
)
    ...
    <style>
        ...
        * {
        ...
        header {
            ...
            align-items: center;
            padding: 0 5%;
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.8)), url('{{bg}}') no-repeat center center/cover;
            position: relative;
        }
...
foreach ($b in $businesses) {
    ...
    $htmlContent = $htmlContent -replace '\{\{bg\}\}', $b.bg
    ...
    [System.IO.File]::WriteAllText($filePath, $htmlContent, $utf8NoBomEncoding)
